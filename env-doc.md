...
Para usar um arquivo .env e carregar variáveis de ambiente (como senhas, chaves API, URL do Supabase etc.) de forma segura no Python, você precisa instalar uma biblioteca extra. A mais comum e recomendada é o python-dotenv.
